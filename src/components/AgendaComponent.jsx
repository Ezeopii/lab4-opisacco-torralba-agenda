  ...
  return (
    <div className="container-agenda">
     ...
     <div className="section-agenda">
       <p className="label-agenda">Seleccione una fecha:</p>
       <input
     ...
     <div className="section-agenda">
       <p className="label-agenda">Seleccione una hora:</p>
       <input
     ...
     <div className="section-agenda">
       ...
       >
         <option className='label-agenda' value="">Selecciona un animal</option>
